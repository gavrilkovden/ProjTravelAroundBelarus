...
{
    internal class CreateFeedbackAttractionCommandValidator : AbstractValidator<CreateFeedbackAttractionCommand>
    {
        public CreateFeedbackAttractionCommandValidator()
        {
            ...
            RuleFor(e => e.Comment).MaximumLength(1000).WithMessage("Comment must be 500 characters or less."); ;
